...
function getRestingTl($el) {
	const $flash1 = $el.find('[ois-branding-idx="1"]');
	const $flash2 = $el.find('[ois-branding-idx="2"]');
	const $flash3 = $el.find('[ois-branding-idx="3"]');
	const $corners = $el.find('[ois-branding-idx="4"]');
